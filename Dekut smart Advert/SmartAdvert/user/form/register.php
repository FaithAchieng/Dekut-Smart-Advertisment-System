    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mt-5 m-auto shadow border border-info">
                <p class="text-primary text-center fs-3 fw-bold my-3">User Registration</p>
                <form action="insert.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="number" placeholder="Enter Username" class="form-control">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                    <button class="w-100 bg-danger fs-4 text-white" >ALREADY ACCOUNT</button>
                    </div>
                </form>
            </div>
        </div>
